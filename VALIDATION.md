...
- Until the Worker URL is configured for the Pages build, the Drive button is disabled and the page explains why. GitHub Pages cannot run the included Node relay; its Drive flow remains available when the full server is hosted.
